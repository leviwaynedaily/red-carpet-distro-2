...
var RemoveScroll = React8.forwardRef(function(props, parentRef) {
  ...
  return React8.createElement(
    React8.Fragment,
    null,
    enabled && React8.createElement(SideCar, { sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime6.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React11.Children.map(children, (child) => (0, import_jsx_runtime6.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime6.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
DialogPortal.displayName = PORTAL_NAME2;
var OVERLAY_NAME = "DialogOverlay";
var DialogOverlay = React11.forwardRef(
  (props, forwardedRef) => {
...
var DialogContentNonModal = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    const hasPointerDownOutsideRef = React11.useRef(false);
    return (0, import_jsx_runtime6.jsx)(
      DialogContentImpl,
      {
        ...props,
...
var DialogClose = React11.forwardRef(
  (props, forwardedRef) => {
